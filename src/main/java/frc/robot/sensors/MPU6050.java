...
public class MPU6050 implements Gyro {
   ...
   * This stored axis is later used when specifying the axis that should measure
   * the yaw.
   */
  public enum YawAxis {
    X,
  ...
  public MPU6050(byte I2CAddress) {
    ...
    m_i2c = new I2C(I2C.Port.kOnboard, m_I2CAddress);
    m_i2c.write(0x6B, 0);
    m_yaw = YawAxis.X;
  }
   ...
   * @param I2CAddress i2c address of the mpu6050. (0x68)
   * 
   * @param yaw        the axis that measures the yaw. X axis by default. can be
   *                   YawAxis.X, YawAxis.Y or YawAxis.Z
   */
  ...
  public double AccDataX() {
    MPUData data = getMPUData();
    return data.m_accX;
  }

  public double AccDataY() {
    MPUData data = getMPUData();
    return data.m_accY;
  }

  public double AccDataZ() {
    MPUData data = getMPUData();
    return data.m_accZ;
  }
